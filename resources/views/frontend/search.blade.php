                            ...
                            <div class="bg-white sidebar-box mb-3">
                                ...
                                <div class="box-content" style="height: 333px;overflow: scroll;">
                                    ...
                                    <div class="filter-checkbox">
                                        @foreach($cats as $cat)
                                            <div class="checkbox">
                                                <input type="checkbox" class="common_selector category" id="attribute_1_value_{{$cat->id}}" name="category" value="{{$cat->id}}" {{$id == $cat->id ? 'checked' : ''}}">
                                ...
                                <div class="box-content" style="height: 333px;overflow: scroll;">
                                    ...
                                    <div class="filter-checkbox" >
                                        @foreach($ends_cats_data as $endcatdat)
                                            <div class="checkbox">
                                                <input type="checkbox" class="common_selector endcategory" id="attribute_3_value_{{$endcatdat->id}}" name="endcategory" value="{{$endcatdat->id}}">
                                ...
                                <div class="sort-by-box flex-grow-1">
                                    <div class="form-group">
                                        ...
                                        <div class="search-widget">
                                            <input class="form-control input-lg searchpro spro"   type="text" name="q" value="{{$q}}" placeholder="Search products">
