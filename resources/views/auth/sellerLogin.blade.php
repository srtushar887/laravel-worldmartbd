                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="px-5 py-3 py-lg-4">
                                <div class="">
                                    <form class="form-default" role="form" action="{{route('seller.login.submit')}}" method="post">
                                        @csrf
                            ...
                            <div class="text-center px-35 pb-3">
                                <p class="text-md">
                                    Need an account? <a href="{{route('seller.register')}}" class="strong-600">Register Now</a>
                                </p>
                            </div>
                        </div>
                    </div>
