                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="email" class="form-control mb-3" placeholder="Your Email" name="email" value="{{Auth::user()->email}}" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Your Phone" name="phone" value="{{Auth::user()->phone}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control textarea-autogrow mb-3" placeholder="House : 001, Street: 002, Section : 003," rows="1" name="address">{!! Auth::user()->address !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker select2-hidden-accessible" data-placeholder="Select your country" name="country" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Your Postal Code" name="zip_code" value="{{Auth::user()->zip_code}}">
                                        </div>
                                    </div>
