    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-box">
                ...
                <form class="parsley-examples" action="{{route('seller.update.product')}}" method="post" enctype="multipart/form-data" novalidate="">
                    @csrf
                    <div class="row">
    ...
    <script>
        $(document).ready(function () {
            $('.delsizdata').click(function (e) {
                ...
                $.ajax({
                    type:'post',
                    url:'{{route('seller.delete.size.edit.data')}}',
                    data:{
                        '_token' : "{{csrf_token()}}",
                        id:id
                    },
            ...
            $('.delcoldata').click(function (e) {
                ...
                $.ajax({
                    type:'post',
                    url:'{{route('seller.delete.color.edit.data')}}',
                    data:{
                        '_token' : "{{csrf_token()}}",
                        id:id
                    },
