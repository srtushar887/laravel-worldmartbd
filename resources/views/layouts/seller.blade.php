        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="ml-1">{{Auth::user('seller')->name}} <i class="mdi mdi-chevron-down"></i> </span>
                </a>
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{route('seller.create.product')}}">Create Product</a></li>
                            <li><a href="{{route('seller.product.list')}}">Product List</a></li>
                            <li><a href="{{route('seller.pending.product.list')}}">Pending Product</a></li>
                            <li><a href="{{route('seller.approved.product.list')}}">Approved Product</a></li>
                            <li><a href="{{route('seller.rejected.product.list')}}">Rejected Product</a></li>
                        </ul>
                    </li>
